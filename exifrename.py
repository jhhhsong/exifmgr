...
for path in paths:
    ...
    for MAINNAME_START_STR in ['DSC', 'IMG', 'dsc', 'dSC']:
        ...
        mainname = '' # neither auto-generated nor newstyle naming
    ...
    if not mainname:
        ...
        naming_scheme = 'new' # generated by this tool
        ...
        naming_scheme = 'dev' # auto-generated by device
    ...
    if method == 'check':
        if dt.timestamp() != name_dt.timestamp():
            print('\t(Warning: name disagrees with EXIF in the specified timezone - this may or may not indicate an incorrect filename)')
    ...
    if modifier_suffix and show_prompt:
        modifier_suffix = input_prefill('\tModifier suffix detected, please confirm desired suffix: ', modifier_suffix)
